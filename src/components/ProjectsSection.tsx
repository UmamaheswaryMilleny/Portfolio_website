...
const projects = [
  {
    ...
    description:
      "A full-stack productivity and accountability platform featuring task management, Pomodoro tracking, calendar scheduling, study-buddy matching, real-time group study rooms, gamification, and premium subscriptions.",
    image: project10,
    tech: [
      "React",
      "TypeScript",
  ...
  },
  {
    ...
    description:
      "A smoothie-themed e-commerce web application featuring secure authentication, smart filtering, seamless checkout, and an admin panel for managing products, users, and analytics.",
    image: project8,
    tech: [
      "EJS",
      "JavaScript",
...

  {
    ...
    description:
      "An AI-powered architectural visualization platform that transforms 2D floor plans into photorealistic 3D renders using advanced AI models, featuring serverless processing workflows and persistent metadata management.",
    image: project9,
  ...
  },
  {
    ...
    description:
      "A sleek, interactive landing page inspired by Apple’s product showcase with smooth scroll animations and immersive visuals.",
    image: project1,
  ...
  },
  {
    ...
    description:
      "A movie browsing web application that displays movie information in a clean and user-friendly interface, focusing on layout clarity and smooth user interaction.",
    image: project2,
...

  {
    ...
    description:
      "An interactive memory matching game where players flip cards to find matching pairs, focusing on simple gameplay, clear visuals, and smooth user interaction.",
    image: project3,
    tech: ["React"],
  ...
  },
  {
    ...
    description:
      "A simple browser-based Tic Tac Toe game featuring interactive gameplay, real-time win detection, and a clean, minimal user interface.",
    image: project4,
  ...
  },
  {
    ...
    description:
      "A responsive clone of the Rockstar Games website focusing on bold visuals, layout accuracy, and smooth interactions",
    image: project5,
  ...
  },
  {
    ...
    description:
      "A static clone of the Uber landing page designed to replicate the original layout and visual style,",
    image: project6,
    tech: ["HTML", "CSS"],
  ...
  },
  {
    ...
    description:
      "A static clone of the Starbucks homepage showcasing clean layout structure",
    image: project7,
    tech: ["HTML", "CSS"],
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="projects-title text-center mb-16">
          ...
          <p className="text-muted-foreground mt-4 max-w-xl mx-auto">
            ...
            development, 3D integration, and creative animations.
          </p>
        </div>
